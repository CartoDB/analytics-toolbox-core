...
grant usage on function ST_ANGLE(GEOGRAPHY, GEOGRAPHY, GEOGRAPHY) to share @@SF_SHARE@@;
grant usage on function ST_AZIMUTH(GEOGRAPHY, GEOGRAPHY) to share @@SF_SHARE@@;
