...
CREATE OR REPLACE FUNCTION __MAKEELLIPSE
...
IMMUTABLE
AS $$
    TO_GEOGRAPHY(__MAKEELLIPSE(CAST(ST_ASGEOJSON(GEOG) AS STRING), XSEMIAXIS, YSEMIAXIS, 0, 'kilometers', 64))
$$;
...
IMMUTABLE
AS $$
    TO_GEOGRAPHY(__MAKEELLIPSE(CAST(ST_ASGEOJSON(GEOG) AS STRING), XSEMIAXIS, YSEMIAXIS, ANGLE, 'kilometers', 64))
$$;
...
IMMUTABLE
AS $$
    TO_GEOGRAPHY(__MAKEELLIPSE(CAST(ST_ASGEOJSON(GEOG) AS STRING), XSEMIAXIS, YSEMIAXIS, ANGLE, UNITS, 64))
$$;
...
IMMUTABLE
AS $$
    TO_GEOGRAPHY(__MAKEELLIPSE(CAST(ST_ASGEOJSON(GEOG) AS STRING), XSEMIAXIS, YSEMIAXIS, ANGLE, UNITS, CAST(STEPS AS DOUBLE)))
$$;