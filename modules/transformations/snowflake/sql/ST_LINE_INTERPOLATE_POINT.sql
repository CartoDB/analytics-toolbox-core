...
CREATE OR REPLACE FUNCTION __LINE_INTERPOLATE_POINT
...
IMMUTABLE
AS $$
    TO_GEOGRAPHY(__LINE_INTERPOLATE_POINT(CAST(ST_ASGEOJSON(GEOG) AS STRING), DISTANCE, 'kilometers'))
$$;
...
IMMUTABLE
AS $$
    TO_GEOGRAPHY(__LINE_INTERPOLATE_POINT(CAST(ST_ASGEOJSON(GEOG) AS STRING), DISTANCE, UNITS))
$$;