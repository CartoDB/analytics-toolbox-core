...
CREATE OR REPLACE FUNCTION __S2_BOUNDARY
(id STRING) 
RETURNS STRING 
LANGUAGE JAVASCRIPT
IMMUTABLE
...
CREATE OR REPLACE FUNCTION __S2_BOUNDARY(id BIGINT) 
RETURNS STRING
IMMUTABLE
AS $$
    __S2_BOUNDARY(CAST(ID AS STRING))
$$;
...
IMMUTABLE
AS $$
    TRY_TO_GEOGRAPHY(__S2_BOUNDARY(ID))
$$;