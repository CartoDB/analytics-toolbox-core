...
CREATE OR REPLACE FUNCTION @@RS_PREFIX@@s2._ST_POLYFILL_BBOX(
    min_longitude FLOAT,
    min_latitude FLOAT,
    max_longitude FLOAT,
    max_latitude FLOAT,
...
CREATE OR REPLACE FUNCTION @@RS_PREFIX@@s2.ST_POLYFILL_BBOX(
    min_longitude FLOAT,
    min_latitude FLOAT,
    max_longitude FLOAT,
    max_latitude FLOAT,
...
IMMUTABLE
AS $$
    SELECT json_parse(@@RS_PREFIX@@s2._ST_POLYFILL_BBOX($1, $2, $3, $4, $5, $6))
$$ LANGUAGE sql;
...
IMMUTABLE
AS $$
    SELECT json_parse(@@RS_PREFIX@@s2._ST_POLYFILL_BBOX($1, $2, $3, $4))
$$ LANGUAGE sql;
