...
CREATE OR REPLACE FUNCTION `@@BQ_PREFIX@@carto.__S2_BOUNDARY`
(id INT64)
RETURNS STRING 
DETERMINISTIC
LANGUAGE js
...
CREATE OR REPLACE FUNCTION `@@BQ_PREFIX@@carto.S2_BOUNDARY`
(id INT64)
RETURNS GEOGRAPHY
AS (
    ST_GEOGFROMTEXT(`@@BQ_PREFIX@@carto.__S2_BOUNDARY`(id))
);