...
test('Returns NULL with invalid parameters', async () => {
    const query = `
        ...
        SELECT
            id,
            \`@@BQ_PREFIX@@carto.H3_BOUNDARY\`(hid) as bounds
        FROM ids
        ORDER BY id ASC
    `;
