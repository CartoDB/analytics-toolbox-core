...
test('Work as expected with NULLish values', async () => {
    ...
    query = `
        SELECT 
        COMPACT(ARRAY_CONSTRUCT()) as c,
        UNCOMPACT(ARRAY_CONSTRUCT(), 5) as u
    `;
