...
grant usage on function @@SF_PREFIX@@h3.LONGLAT_ASH3(DOUBLE, DOUBLE, INT) to share @@SF_SHARE@@;
grant usage on function @@SF_PREFIX@@h3.ST_ASH3(GEOGRAPHY, INT) to share @@SF_SHARE@@;
grant usage on function @@SF_PREFIX@@h3.ST_ASH3_POLYFILL(GEOGRAPHY, INT) to share @@SF_SHARE@@;
grant usage on function @@SF_PREFIX@@h3.ST_BOUNDARY(STRING) to share @@SF_SHARE@@;
grant usage on function @@SF_PREFIX@@h3.TOCHILDREN(STRING, INT) to share @@SF_SHARE@@;
grant usage on function @@SF_PREFIX@@h3.TOPARENT(STRING, INT) to share @@SF_SHARE@@;
grant usage on function @@SF_PREFIX@@h3.VERSION() to share @@SF_SHARE@@;