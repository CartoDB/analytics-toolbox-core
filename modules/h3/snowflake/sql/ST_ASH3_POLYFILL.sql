...
CREATE OR REPLACE FUNCTION _ST_ASH3_POLYFILL
...
CREATE OR REPLACE SECURE FUNCTION ST_ASH3_POLYFILL
(geog GEOGRAPHY, resolution INT)
RETURNS ARRAY
AS $$
    _ST_ASH3_POLYFILL(CAST(ST_ASGEOJSON(GEOG) AS STRING), CAST(RESOLUTION AS DOUBLE))
$$;