...
test('QUADINT_BOUNDARY should work', async () => {
    ...
    expect(JSON.stringify(rows[8].boundary.value)).toEqual('"POLYGON((-180 0, -180 -66.5132604431118, -90 -66.5132604431118, -90 0, -180 0))"');
    expect(JSON.stringify(rows[9].boundary.value)).toEqual('"POLYGON((-180 -66.5132604431118, -180 -85.0511287798066, -90 -85.0511287798066, -90 -66.5132604431118, -180 -66.5132604431118))"');
