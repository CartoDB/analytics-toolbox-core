...
`@@BQ_PREFIX@@carto.__TILE_TOLONG`(`@@BQ_PREFIX@@carto.QUADINT_TOZXY`(quadint).x+0.5,`@@BQ_PREFIX@@carto.QUADINT_TOZXY`(quadint).z),
-- y + 0.5 is the mean between the northern (y) and southern (y+1) limits of the cell.
`@@BQ_PREFIX@@carto.__TILE_TOLAT`(`@@BQ_PREFIX@@carto.QUADINT_TOZXY`(quadint).y+0.5,`@@BQ_PREFIX@@carto.QUADINT_TOZXY`(quadint).z)
)
);
