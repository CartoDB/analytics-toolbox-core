...
def test_bbox():
    assert quadkeyLib.bbox(162) == [-90, 0, 0, 66.51326044311186]
    assert quadkeyLib.bbox(12070922) == [
        -45,
        44.84029065139799,
        -44.6484375,
        45.089035564831015,
    ]
    assert quadkeyLib.bbox(791040491538) == [
        -45,
        44.999767019181284,
        -44.998626708984375,
        45.000738078290674,
    ]
    assert quadkeyLib.bbox(12960460429066265) == [
        -45,
        44.99999461263668,
        -44.99998927116394,
        45.00000219906961,
