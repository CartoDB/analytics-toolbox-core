...
CREATE OR REPLACE FUNCTION @@RS_PREFIX@@quadkey.__QUADINT_POLYFILL
...
CREATE OR REPLACE FUNCTION @@RS_PREFIX@@quadkey.QUADINT_POLYFILL
(GEOMETRY, INT)
-- (geo, resolution)
RETURNS SUPER
STABLE
AS $$
    SELECT json_parse(@@RS_PREFIX@@quadkey.__QUADINT_POLYFILL(ST_ASGEOJSON($1)::VARCHAR(MAX), $2))
$$ LANGUAGE sql;