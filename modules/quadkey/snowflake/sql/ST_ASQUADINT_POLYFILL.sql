...
CREATE OR REPLACE FUNCTION _POLYFILL_FROMGEOJSON
...
CREATE OR REPLACE SECURE FUNCTION ST_ASQUADINT_POLYFILL
(geo GEOGRAPHY, resolution INT)
RETURNS ARRAY
AS $$
    _POLYFILL_FROMGEOJSON(CAST(ST_ASGEOJSON(GEO) AS STRING),CAST(RESOLUTION AS DOUBLE))
$$;