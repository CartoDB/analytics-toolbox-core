...
CREATE OR REPLACE FUNCTION _KRING_DISTANCES
...
CREATE OR REPLACE SECURE FUNCTION KRING_DISTANCES
(origin BIGINT, size INT)
RETURNS ARRAY
AS $$
    _KRING_DISTANCES(CAST(ORIGIN AS STRING), CAST(SIZE AS DOUBLE))
$$;