...
CASE
    ...
    WHEN quadbin = 5192650370358181887 THEN TO_GEOGRAPHY(
    ...
    WHEN quadbin = 5193776270265024511 THEN TO_GEOGRAPHY (
        'POLYGON((0 0, 0 85.0511287798066, -180 85.0511287798066, -180 0, -90 0, 0 0))'
    )
    WHEN quadbin = 5194902170171867135 THEN TO_GEOGRAPHY (
        'POLYGON((180 0, 180 85.0511287798066, 0 85.0511287798066, 0 0, 90 0, 180 0))'
    )
    WHEN quadbin = 5196028070078709759 THEN TO_GEOGRAPHY (
        'POLYGON((0 0, -90 0, 180 0, -180 -85.0511287798066, 0 -85.0511287798066, 0 0))'
    )
    WHEN quadbin = 5197153969985552383 THEN TO_GEOGRAPHY (
