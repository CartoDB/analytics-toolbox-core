...
processing.ST_LINE_INTERPOLATE_POINT(geog, distance, units)
{{%/ bannerNote %}}
...
``` sql
SELECT bqcarto.processing.ST_LINE_INTERPOLATE_POINT(ST_GEOGFROMTEXT("LINESTRING (-76.091308 18.427501,-76.695556 18.729501,-76.552734 19.40443,-74.61914 19.134789,-73.652343 20.07657,-73.157958 20.210656)"),250,'miles');
