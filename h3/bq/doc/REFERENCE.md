...
If you want the INT representation of the cell, you can call [H3_ASINT](#h3_asint) with the output integer.
{{%/ bannerNote %}}
...
Returns the H3 index as a decimal number (generated by [H3_FROMINT](#h3_fromint)). It doesn't do any extra validation checks.
