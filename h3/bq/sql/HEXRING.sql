...
CREATE OR REPLACE FUNCTION `@@BQ_PROJECTID@@.@@BQ_DATASET_H3@@.__HEXRING`(index_lower INT64, index_upper INT64, distance INT64)
    RETURNS ARRAY<INT64>
    DETERMINISTIC
    LANGUAGE js
...
AS
(
    `@@BQ_PROJECTID@@.@@BQ_DATASET_H3@@.__HEXRING`(index & 0x00000000FFFFFFFF, index >> 32, distance)
);