...
CREATE OR REPLACE FUNCTION `@@BQ_PROJECTID@@.@@BQ_DATASET_H3@@._ST_BOUNDARY`(index_lower INT64, index_upper INT64)
    RETURNS STRING
    DETERMINISTIC
    LANGUAGE js
...
AS
(
    ST_GEOGFROMTEXT(`@@BQ_PROJECTID@@.@@BQ_DATASET_H3@@._ST_BOUNDARY`(index & 0x00000000FFFFFFFF, index >> 32))
);