...
```sql
SELECT SFCARTO.H3.H3_FROMHEX("847b59dffffffff");
-- 596645165859340287
```
...
```sql
SELECT SFCARTO.H3.COMPACT([601148757970518015, 601148759044259839, 601148760118001663,
...
```sql
SELECT SFCARTO.H3.UNCOMPACT([596645165859340287], 5);
-- 601148757970518015
-- 601148759044259839
-- 601148760118001663
-- 601148761191743487
