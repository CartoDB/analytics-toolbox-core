...
{{% bannerNote type="code" %}}
measurements.ST_CENTERMEAN(geog)
{{%/ bannerNote %}}
...
``` sql
SELECT bqcarto.measurements.ST_CENTERMEAN(ST_GEOGFROMTEXT("POLYGON ((30 10, 40 40, 20 40, 10 20, 30 10))"));
...
{{% bannerNote type="code" %}}
measurements.ST_CENTEROFMASS(geog)
{{%/ bannerNote %}}
...
``` sql
SELECT bqcarto.measurements.ST_CENTEROFMASS(ST_GEOGFROMTEXT("POLYGON ((30 10, 40 40, 20 40, 10 20, 30 10))"));
