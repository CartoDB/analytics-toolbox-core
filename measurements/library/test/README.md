...
These are the set of tests that verify the behaviour of the JS library generated to support measurements. They are designed to be used under `node` and `npm` to simulate the behaviour of the library under BigQuery.
