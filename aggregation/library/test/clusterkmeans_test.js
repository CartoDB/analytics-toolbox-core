...
global.eval(fs.readFileSync('../../aggregation_library.js') + '');
...
const clustersKmeans = turf.clustersKmeans;

const directories = {
  in: path.join(__dirname, "clusterkmeans_test", "in") + path.sep,
  out: path.join(__dirname, "clusterkmeans_test", "out") + path.sep,
};
