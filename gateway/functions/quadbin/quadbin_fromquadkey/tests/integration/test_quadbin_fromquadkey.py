"""Integration tests for QUADBIN_FROMQUADKEY function"""
...
class TestQuadbinFromquadkeyIntegration:
    """Integration tests for QUADBIN_FROMQUADKEY with Redshift"""

    @pytest.mark.parametrize("quadkey, quadbin", input)
    def test_quadbin_fromquadkey(self, quadkey, quadbin):
