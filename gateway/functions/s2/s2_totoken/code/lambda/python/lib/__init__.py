"""
S2TOTOKEN function implementation using shared s2 utilities.
...
try:
    ...
    from lib.s2 import int64_id_to_token
except ImportError:
    # Fall back to shared library (local testing)
    from s2 import int64_id_to_token


__all__ = ["int64_id_to_token"]
