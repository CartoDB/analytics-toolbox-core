"""
S2TOUINT64REPR function implementation using shared s2 utilities.
...
try:
    ...
    from lib.s2 import uint64_repr_from_id
except ImportError:
    # Fall back to shared library (local testing)
    from s2 import uint64_repr_from_id


__all__ = ["uint64_repr_from_id"]
