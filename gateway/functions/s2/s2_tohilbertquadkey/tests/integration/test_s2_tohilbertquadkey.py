...
def test_s2_tohilbertquadkey():
    """Test S2_TOHILBERTQUADKEY converts cell IDs to Hilbert quadkeys"""
    ...
    fixture_path = os.path.join(here, "fixtures/s2_tohilbertquadkey_out.txt")
