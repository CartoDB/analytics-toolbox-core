...
def test_s2_totoken_success():
    ...
    with open(f'{here}/fixtures/s2_totoken_out.txt', 'r') as fixture_file:
...
def test_s2_totoken_null_failure():
    with pytest.raises(redshift_connector.error.ProgrammingError) as excinfo:
        run_query('SELECT @@RS_SCHEMA@@.S2_TOTOKEN(NULL)')
