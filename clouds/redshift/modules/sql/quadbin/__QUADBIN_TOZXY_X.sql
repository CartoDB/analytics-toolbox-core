...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_XY_INTERLEAVED5(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_XY_INTERLEAVED4(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_XY_INTERLEAVED3(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_XY_INTERLEAVED2(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_XY_INTERLEAVED1(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_XY_PREINTERLEAVED(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.__QUADBIN_TOZXY_X(BIGINT)
-- (quadbin)
RETURNS BIGINT
STABLE
AS $$
