...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.ST_DESTINATION(GEOMETRY, FLOAT8, FLOAT8)
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.ST_DESTINATION(GEOMETRY, FLOAT8, FLOAT8, VARCHAR(15))
