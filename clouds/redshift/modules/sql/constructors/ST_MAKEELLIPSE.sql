...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.ST_MAKEELLIPSE(GEOMETRY, FLOAT8, FLOAT8)
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.ST_MAKEELLIPSE(GEOMETRY, FLOAT8, FLOAT8, FLOAT8)
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.ST_MAKEELLIPSE(GEOMETRY, FLOAT8, FLOAT8, FLOAT8, VARCHAR(10))
...
CREATE OR REPLACE FUNCTION @@RS_SCHEMA@@.ST_MAKEELLIPSE(GEOMETRY, FLOAT8, FLOAT8, FLOAT8, VARCHAR(10), INT)
