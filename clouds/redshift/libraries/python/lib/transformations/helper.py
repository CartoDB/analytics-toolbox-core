...
def distance(p1, p2, units):
    ...
    A point is containing latitude and logitude in decimal
    degrees and ``unit`` is optional. It calculates distance in units such as
    kilometers, meters, miles, feet and inches.
...
def bearing(start, end, final=False):
    """
    Take two Point and finds the geographic bearing between them.
