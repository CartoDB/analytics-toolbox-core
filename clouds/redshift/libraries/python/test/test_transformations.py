...
def test_centroid_linestring():
    ...
    centroid1 = transformations.centroid_linestring(linestring1)
    centroid2 = transformations.centroid_linestring(linestring2)
...
def test_centroid_polygon():
    ...
    centroid1 = transformations.centroid_polygon(polygon1)
    centroid2 = transformations.centroid_polygon(polygon2)
...
def test_remove_end_polygon_point():
    ...
    assert (
        str(transformations.remove_end_polygon_point(geojson1.coordinates))
        == '[(30.0, 10.0), (40.0, 40.0), (20.0, 40.0), (10.0, 20.0)]'
    )
    assert (
        str(transformations.remove_end_polygon_point(geojson2.coordinates))
        == '[(35.0, 10.0), (45.0, 45.0), (15.0, 40.0), (10.0, 20.0), (20.0, 30.0), '
        '(35.0, 35.0), (30.0, 20.0)]'
    )
    assert (
        str(transformations.remove_end_polygon_point(geojson3.coordinates))
        == '[(30.0, 20.0), (45.0, 40.0), (10.0, 40.0), (15.0, 5.0), (40.0, 10.0), '
        '(10.0, 20.0), (5.0, 10.0)]'
    )
    assert (
        str(transformations.remove_end_polygon_point(geojson4.coordinates))
