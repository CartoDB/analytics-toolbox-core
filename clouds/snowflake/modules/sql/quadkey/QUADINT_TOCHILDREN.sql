...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._QUADINT_TOCHILDREN(quadint STRING, resolution DOUBLE)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADINT_TOCHILDREN(quadint BIGINT, resolution INT)
RETURNS ARRAY
IMMUTABLE
AS $$
