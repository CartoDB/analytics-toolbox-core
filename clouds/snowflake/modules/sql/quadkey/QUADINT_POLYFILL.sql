...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._QUADINT_POLYFILL(geojson STRING, resolution DOUBLE)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADINT_POLYFILL(geo GEOGRAPHY, resolution INT)
RETURNS ARRAY
IMMUTABLE
AS $$
