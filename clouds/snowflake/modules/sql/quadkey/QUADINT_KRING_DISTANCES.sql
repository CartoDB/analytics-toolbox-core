...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._QUADINT_KRING_DISTANCES(origin STRING, size DOUBLE)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADINT_KRING_DISTANCES(origin BIGINT, size INT)
RETURNS ARRAY
IMMUTABLE
AS $$
