...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._QUADBIN_TOCHILDREN(index STRING, resolution DOUBLE)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADBIN_TOCHILDREN(quadbin BIGINT, resolution INT)
RETURNS ARRAY
IMMUTABLE
AS $$
