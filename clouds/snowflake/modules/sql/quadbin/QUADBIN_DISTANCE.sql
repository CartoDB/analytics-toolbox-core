...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._QUADBIN_DISTANCE(origin STRING, destination STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADBIN_DISTANCE(origin BIGINT, destination BIGINT)
RETURNS BIGINT
IMMUTABLE
AS $$
