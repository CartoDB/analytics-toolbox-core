...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADBIN_FROMLONGLAT(longitude FLOAT, latitude FLOAT, resolution INT)
RETURNS BIGINT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@._QUADBIN_FROMLONGLAT(longitude FLOAT, latitude FLOAT, resolution INT)
RETURNS BIGINT
IMMUTABLE
AS $$
    WITH
