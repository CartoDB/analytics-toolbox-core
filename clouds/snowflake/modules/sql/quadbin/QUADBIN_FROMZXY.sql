...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._QUADBIN_FROMZXY(z DOUBLE, x DOUBLE, y DOUBLE)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.QUADBIN_FROMZXY(z INT, x INT, y INT)
RETURNS BIGINT
IMMUTABLE
AS $$
