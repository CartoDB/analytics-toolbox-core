...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._CLUSTERKMEANS(geojsons ARRAY, numberOfClusters DOUBLE)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_CLUSTERKMEANS(geojsons ARRAY)
RETURNS ARRAY
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_CLUSTERKMEANS(geojsons ARRAY, numberOfClusters INT)
RETURNS ARRAY
IMMUTABLE
AS $$
