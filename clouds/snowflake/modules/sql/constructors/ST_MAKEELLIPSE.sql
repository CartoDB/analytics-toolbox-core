...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_MAKEELLIPSE(geog GEOGRAPHY, xSemiAxis DOUBLE, ySemiAxis DOUBLE)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_MAKEELLIPSE(geog GEOGRAPHY, xSemiAxis DOUBLE, ySemiAxis DOUBLE, angle DOUBLE)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_MAKEELLIPSE(geog GEOGRAPHY, xSemiAxis DOUBLE, ySemiAxis DOUBLE, angle DOUBLE, units STRING)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
