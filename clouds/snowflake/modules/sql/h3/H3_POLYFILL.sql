...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._HAS_POLYGON_JS(geojson STRING)
RETURNS BOOLEAN
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._HAS_POLYGON(geog GEOGRAPHY)
RETURNS BOOLEAN
LANGUAGE SQL
IMMUTABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._FILTER_GEOG_JS(geojson STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._FILTER_GEOG(geog GEOGRAPHY)
RETURNS GEOGRAPHY
LANGUAGE SQL
IMMUTABLE
AS $$
...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._H3_POLYFILL_CONTAINS(geojson STRING, indexes ARRAY)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@._H3_POLYFILL_INTERSECTS_FILTER(h3Indexes ARRAY, geojson STRING)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.H3_POLYFILL(geog GEOGRAPHY, resolution INT)
RETURNS ARRAY
IMMUTABLE
AS $$
    IFF(
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.H3_POLYFILL(geog GEOGRAPHY, resolution INT, mode STRING)
RETURNS ARRAY
IMMUTABLE
AS $$
