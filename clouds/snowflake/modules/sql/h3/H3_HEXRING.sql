...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._H3_HEXRING(origin STRING, size DOUBLE)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.H3_HEXRING(origin STRING, size INT)
RETURNS ARRAY
IMMUTABLE
AS $$
