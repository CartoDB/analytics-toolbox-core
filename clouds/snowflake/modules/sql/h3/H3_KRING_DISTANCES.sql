...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._H3_KRING_DISTANCES(origin STRING, hexarray ARRAY)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.H3_KRING_DISTANCES(origin STRING, size INT)
RETURNS ARRAY
IMMUTABLE
AS $$
    CASE
