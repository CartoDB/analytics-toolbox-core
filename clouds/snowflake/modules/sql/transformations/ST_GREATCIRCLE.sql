...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._GREATCIRCLE(geojsonStart STRING, geojsonEnd STRING, npoints DOUBLE)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_GREATCIRCLE(startPoint GEOGRAPHY, endPoint GEOGRAPHY)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_GREATCIRCLE(startPoint GEOGRAPHY, endPoint GEOGRAPHY, npoints INT)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
