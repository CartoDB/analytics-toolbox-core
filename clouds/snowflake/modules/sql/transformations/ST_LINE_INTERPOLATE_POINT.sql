...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._LINE_INTERPOLATE_POINT(geojson STRING, distance DOUBLE, units STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_LINE_INTERPOLATE_POINT(geog GEOGRAPHY, distance DOUBLE)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_LINE_INTERPOLATE_POINT(geog GEOGRAPHY, distance DOUBLE, units STRING)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
