...
CREATE OR REPLACE FUNCTION @@SF_SCHEMA@@._DESTINATION(geojsonStart STRING, distance DOUBLE, bearing DOUBLE, units STRING)
RETURNS STRING
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_DESTINATION(startPoint GEOGRAPHY, distance DOUBLE, bearing DOUBLE)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_DESTINATION(startPoint GEOGRAPHY, distance DOUBLE, bearing DOUBLE, units STRING)
RETURNS GEOGRAPHY
IMMUTABLE
AS $$
