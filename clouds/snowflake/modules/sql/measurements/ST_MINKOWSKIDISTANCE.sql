...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_MINKOWSKIDISTANCE(geojsons ARRAY, p DOUBLE)
RETURNS ARRAY
LANGUAGE JAVASCRIPT
IMMUTABLE
AS $$
...
CREATE OR REPLACE SECURE FUNCTION @@SF_SCHEMA@@.ST_MINKOWSKIDISTANCE(geojsons ARRAY)
RETURNS ARRAY
IMMUTABLE
AS $$
