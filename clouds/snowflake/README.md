...
# Option 1: Password (for local development)
SF_PASSWORD=<password>

# Option 2: RSA key (for CI) - export manually before running make:
# export SF_RSA_KEY=$'-----BEGIN ENCRYPTED PRIVATE KEY-----\n...\n-----END ENCRYPTED PRIVATE KEY-----'
# export SF_RSA_KEY_PASSWORD='...'
```
