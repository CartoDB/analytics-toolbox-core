...
test('ST_GREATCIRCLE should work', async () => {
    const query = `SELECT \`@@BQ_DATASET@@.ST_GREATCIRCLE\`(ST_GEOGPOINT(0, 0), ST_GEOGPOINT(0, 10), 11) as greatcircle1,
    \`@@BQ_DATASET@@.ST_GREATCIRCLE\`(ST_GEOGPOINT(-1.70325, 1.4167), ST_GEOGPOINT(1.70325, -1.4167), 5) as greatcircle2,
    \`@@BQ_DATASET@@.ST_GREATCIRCLE\`(ST_GEOGPOINT(5, 5), ST_GEOGPOINT(-5, -5), 9) as greatcircle3`;
...
test('ST_GREATCIRCLE should return NULL if any NULL mandatory argument', async () => {
    const query = `SELECT \`@@BQ_DATASET@@.ST_GREATCIRCLE\`(NULL, ST_GEOGPOINT(-73.9385,40.6643), 20) as greatcircle1,
    \`@@BQ_DATASET@@.ST_GREATCIRCLE\`(ST_GEOGPOINT(-3.70325,40.4167), NULL, 20) as greatcircle2`;
    const rows = await runQuery(query);
    expect(rows.length).toEqual(1);
