...
test('Work with polyfill arrays', async () => {
    const query = `
        WITH poly AS
        (
        SELECT \`@@BQ_DATASET@@.H3_POLYFILL_MODE\`(ST_GEOGFROMTEXT('POLYGON((-122.4089866999972145 37.813318999983238, -122.3805436999997056 37.7866302000007224, -122.3544736999993603 37.7198061999978478, -122.5123436999983966 37.7076131999975672, -122.5247187000021967 37.7835871999971715, -122.4798767000009008 37.8151571999998453, -122.4089866999972145 37.813318999983238))'), 9, 'intersects') AS v
        )
        SELECT
