...
test('QUADINT_TOGEOGPOINT should work', async () => {
    const query = `
        SELECT
            \`@@BQ_DATASET@@.QUADINT_TOGEOGPOINT\`(12070922) as geog1,
            \`@@BQ_DATASET@@.QUADINT_TOGEOGPOINT\`(791040491538) as geog2,
            \`@@BQ_DATASET@@.QUADINT_TOGEOGPOINT\`(12960460429066265) as geog3`;
