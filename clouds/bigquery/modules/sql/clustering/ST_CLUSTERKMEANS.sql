...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__CLUSTERKMEANS`(geojson ARRAY<STRING>, numberOfClusters INT64)
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_CLUSTERKMEANS`(geog ARRAY<GEOGRAPHY>, numberOfClusters INT64)
