...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__QUADINT_POLYFILL`(geojson STRING, resolution INT64)
RETURNS ARRAY<INT64>
DETERMINISTIC
LANGUAGE js
OPTIONS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.QUADINT_POLYFILL`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<INT64>
AS (
