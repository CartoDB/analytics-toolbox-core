...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__MINKOWSKIDISTANCE`(geojson ARRAY<STRING>, p FLOAT64)
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_MINKOWSKIDISTANCE`(geog ARRAY<GEOGRAPHY>, p FLOAT64)
RETURNS ARRAY<STRING>
AS ((
