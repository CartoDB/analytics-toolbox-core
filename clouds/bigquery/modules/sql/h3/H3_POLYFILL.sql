...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_GEOJSON`(geojson STRING, _resolution INT64)
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_AVG_EDGE_LENGTH`(resolution INT64)
RETURNS FLOAT64
DETERMINISTIC
LANGUAGE js
AS """
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_AVG_HEXAGON_AREA`(resolution INT64)
RETURNS FLOAT64
DETERMINISTIC
LANGUAGE js
AS """
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_INIT_BBOX`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<STRING>
AS ((
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_INIT_SIMP`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<STRING>
AS ((
    IF(geog IS NULL OR resolution IS NULL,
        NULL,
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_INIT_Z`(geog GEOGRAPHY, resolution INT64)
RETURNS INT64
AS ((
    WITH __params AS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_CHILDREN_INTERSECTS`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<STRING>
AS ((
    WITH __cells AS (
        SELECT h3
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_CHILDREN_CONTAINS`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<STRING>
AS ((
    WITH __cells AS (
        SELECT h3
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__H3_POLYFILL_CHILDREN_CENTER`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<STRING>
AS ((
    WITH __cells AS (
        SELECT h3
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.H3_POLYFILL_MODE`(geog GEOGRAPHY, resolution INT64, mode STRING)
RETURNS ARRAY<STRING>
AS ((
    CASE mode
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.H3_POLYFILL`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<STRING>
AS ((
