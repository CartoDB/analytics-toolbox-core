...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__BEZIERSPLINE`(geojson STRING, resolution INT64, sharpness FLOAT64)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
OPTIONS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_BEZIERSPLINE`(geog GEOGRAPHY, resolution INT64, sharpness FLOAT64)
RETURNS GEOGRAPHY
AS (
    ST_GEOGFROMGEOJSON(
