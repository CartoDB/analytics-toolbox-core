...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__ST_GENERATEPOINTS`(geojson STRING, npoints INT64)
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_GENERATEPOINTS`(geog GEOGRAPHY, npoints INT64)
