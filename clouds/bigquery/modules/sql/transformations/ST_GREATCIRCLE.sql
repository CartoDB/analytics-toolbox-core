...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__GREATCIRCLE`(geojsonStart STRING, geojsonEnd STRING, npoints INT64)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
OPTIONS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_GREATCIRCLE`(startPoint GEOGRAPHY, endPoint GEOGRAPHY, npoints INT64)
RETURNS GEOGRAPHY
AS (
    ST_GEOGFROMGEOJSON(
