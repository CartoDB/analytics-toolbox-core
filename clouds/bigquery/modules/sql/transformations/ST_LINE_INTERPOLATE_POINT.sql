...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__LINE_INTERPOLATE_POINT`(geojson STRING, distance FLOAT64, units STRING)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
OPTIONS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_LINE_INTERPOLATE_POINT`(geog GEOGRAPHY, distance FLOAT64, units STRING)
RETURNS GEOGRAPHY
AS (
    ST_GEOGFROMGEOJSON(
