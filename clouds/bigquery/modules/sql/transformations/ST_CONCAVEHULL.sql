...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__CONCAVEHULL`(geojson ARRAY<STRING>, maxEdge FLOAT64, units STRING)
RETURNS STRING
DETERMINISTIC
LANGUAGE js
OPTIONS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.ST_CONCAVEHULL`(geog ARRAY<GEOGRAPHY>, maxEdge FLOAT64, units STRING)
RETURNS GEOGRAPHY
AS ((
