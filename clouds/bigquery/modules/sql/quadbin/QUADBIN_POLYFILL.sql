...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__QUADBIN_POLYFILL_INIT`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<INT64>
AS ((
    WITH __bbox AS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__GEOG_RESOLUTION`(geog GEOGRAPHY, resolution INT64)
RETURNS INT64
AS ((
    WITH __geog_area AS (
        SELECT
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__QUADBIN_POLYFILL_INTERSECTS`(geog GEOGRAPHY, use_contains BOOLEAN, init_resolution INT64, resolution INT64)
RETURNS ARRAY<INT64>
AS ((
    WITH __parents AS (
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__QUADBIN_POLYFILL_CONTAINS`(geog GEOGRAPHY, use_contains BOOLEAN, init_resolution INT64, resolution INT64)
RETURNS ARRAY<INT64>
AS ((
    WITH __parents AS (
        SELECT parent, COALESCE(ST_CONTAINS(
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.__QUADBIN_POLYFILL_CENTER`(geog GEOGRAPHY, use_contains BOOLEAN, init_resolution INT64, resolution INT64)
RETURNS ARRAY<INT64>
AS ((
    WITH __parents AS (
        SELECT parent, COALESCE(ST_CONTAINS(
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.QUADBIN_POLYFILL_MODE`(geog GEOGRAPHY, resolution INT64, mode STRING)
RETURNS ARRAY<INT64>
AS ((
...
CREATE OR REPLACE FUNCTION `@@BQ_DATASET@@.QUADBIN_POLYFILL`(geog GEOGRAPHY, resolution INT64)
RETURNS ARRAY<INT64>
AS ((
