...
public class TWKBWriter {
    ...
    private TWKBHeader prepareHeader(Geometry geometry, TWKBHeader params,
        ...
        final TWKBHeader.GeometryType geometryType = TWKBHeader.GeometryType.valueOf(geometry.getClass());
    ...
    private void writeGeometryBody(Geometry geom, TWKBOutputStream out, TWKBHeader header)
        ...
        final TWKBHeader.GeometryType geometryType = TWKBHeader.GeometryType.valueOf(geom.getClass());
        switch (geometryType) {
            case POINT:
