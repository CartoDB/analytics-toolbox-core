...
test('h3 library defined', () => {
    ...
    expect(h3Lib.h3GetResolution).toBeDefined();
    ...
    expect(h3Lib.h3ToGeo).toBeDefined();
    ...
    expect(h3Lib.bboxClip).toBeDefined();
    expect(h3Lib.removeNextDuplicates).toBeDefined();
});