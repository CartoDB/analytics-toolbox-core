...
def test_quadbin_sibling_up():
    ...
    result = run_query(
        "SELECT @@PG_SCHEMA@@.QUADBIN_SIBLING(5209574053332910079, 'up')"
    )
...
def test_quadbin_sibling_down():
    ...
    result = run_query(
        "SELECT @@PG_SCHEMA@@.QUADBIN_SIBLING(5209574053332910079, 'down')"
    )
...
def test_quadbin_sibling_left():
    ...
    result = run_query(
        "SELECT @@PG_SCHEMA@@.QUADBIN_SIBLING(5209574053332910079, 'left')"
    )
...
def test_quadbin_sibling_right():
    """Computes left sibling."""
    result = run_query(
        "SELECT @@PG_SCHEMA@@.QUADBIN_SIBLING(5209574053332910079, 'right')"
    )
...
def test_quadbin_sibling_null():
    ...
    result = run_query(
        "SELECT @@PG_SCHEMA@@.QUADBIN_SIBLING(5192650370358181887, 'up')"
    )
