...
-- Type used by this function. Inline declaration with idempotent
-- DROP+CREATE FORCE (per .claude/rules/oracle.md). Other quadbin
-- functions also declare QUADBIN_ZXY; duplication is intentional —
