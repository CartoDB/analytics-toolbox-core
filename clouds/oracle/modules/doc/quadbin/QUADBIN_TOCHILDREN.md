...
* `quadbin`: `NUMBER` Quadbin to get the children from.
* `resolution`: `NUMBER` resolution of the desired children.
...
```sql
SELECT COLUMN_VALUE
FROM TABLE(carto.QUADBIN_TOCHILDREN(5207251884775047167, 5));
-- 5211742290262884351
-- 5211751086355906559
-- 5211746688309395455
-- 5211755484402417663
