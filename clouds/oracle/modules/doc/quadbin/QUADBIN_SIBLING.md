...
* `quadbin`: `NUMBER` Quadbin to get the sibling from.
* `direction`: `VARCHAR2` <code>'right'|'left'|'up'|'down'</code> direction to move in to extract the next sibling.
...
```sql
SELECT carto.QUADBIN_SIBLING(5207251884775047167, 'up') FROM DUAL;
-- 5207146331658780671
```
