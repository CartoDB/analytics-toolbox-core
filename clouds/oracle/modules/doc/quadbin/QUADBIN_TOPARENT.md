...
* `quadbin`: `NUMBER` Quadbin to get the parent from.
* `resolution`: `NUMBER` resolution of the desired parent.
...
```sql
SELECT carto.QUADBIN_TOPARENT(5207251884775047167, 3) FROM DUAL;
-- 5202783469519765503
```
