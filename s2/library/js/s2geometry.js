...
try {
    wasm = new WebAssembly.Instance(new WebAssembly.Module(new Uint8Array([
        ...
        66, 32, 134, 132, 126, 34, 4, 66, 32, 135, 167, 36, 0, 32, 4, 167,
        11, 36, 1, 1, 126, 32, 0, 173, 32, 1, 173, 66, 32, 134, 132, 32, 2,
        173, 32, 3, 173, 66, 32, 134, 132, 127, 34, 4, 66, 32, 135, 167, 36,
        0, 32, 4, 167, 11, 36, 1, 1, 126, 32, 0, 173, 32, 1, 173, 66, 32, 134,
        132, 32, 2, 173, 32, 3, 173, 66, 32, 134, 132, 128, 34, 4, 66, 32, 135,
        167, 36, 0, 32, 4, 167, 11, 36, 1, 1, 126, 32, 0, 173, 32, 1, 173, 66,
        32, 134, 132, 32, 2, 173, 32, 3, 173, 66, 32, 134, 132, 129, 34, 4, 66,
        32, 135, 167, 36, 0, 32, 4, 167, 11, 36, 1, 1, 126, 32, 0, 173, 32, 1,
        173, 66, 32, 134, 132, 32, 2, 173, 32, 3, 173, 66, 32, 134, 132, 130,
        34, 4, 66, 32, 135, 167, 36, 0, 32, 4, 167, 11
    ])), {}).exports;
} catch (e) {
    // no wasm support :(
}
...
function fromString(str, unsigned, radix) {
    ...
    const radixToPower = fromNumber(powDbl(radix, 8));
    ...
    for (let i = 0; i < str.length; i += 8) {
        ...
        if (size < 8) {
            const power = fromNumber(powDbl(radix, size));
...
LongPrototype.toString = function toString(radix) {
    ...
    // minimize the calls to the very expensive emulated div.
    const radixToPower = fromNumber(powDbl(radix, 6), this.unsigned);
    let rem = this;
    let result = '';
    while (true) {
...
LongPrototype.add = function add(addend) {
    ...
    let c48 = 0; let c32 = 0; let c16 = 0; let c00 = 0;
    c00 += a00 + b00;
    c16 += c00 >>> 16;
    c00 &= 0xFFFF;
    c16 += a16 + b16;
    ...
    */
      ...
      const pointToHilbertQuadList = function(x, y, order, face) {
          ...
          for (let i = order - 1; i >= 0; i--) {
              ...
              const t = hilbertMap[currentSquare][quadX * 2 + quadY];
